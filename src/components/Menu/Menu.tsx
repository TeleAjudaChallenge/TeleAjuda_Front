...
export default function Menu(){
    ...
    return(
        <nav>
            {/* O hamburger agora é escondido a partir do breakpoint 'lg' */}
            ...
            {/* O menu desktop agora aparece a partir do 'lg' e tem padding responsivo */}
            ...
            {/* O menu mobile também é escondido a partir do 'lg' */}
            {isOpen && (
