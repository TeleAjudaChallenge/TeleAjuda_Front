        ...
        <nav>
            ...
            <div className={`fixed top-0 right-0 h-full w-4/5 max-w-sm bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'} lg:hidden`}>
                ...
                <ul className="flex flex-col p-4 space-y-2">
                    <li><NavLink to={"/"} onClick={closeMenu} className={getMobileLinkClass}>Início</NavLink></li>
                    <li><NavLink to={"/chamados"} onClick={closeMenu} className={getMobileLinkClass}>Abrir Chamado</NavLink></li>
                    <li><NavLink to={"/sobre"} onClick={closeMenu} className={getMobileLinkClass}>Sobre o Projeto</NavLink></li>
                    <li><NavLink to={"/faq"} onClick={closeMenu} className={getMobileLinkClass}>Central de Ajuda</NavLink></li>
                </ul>
            </div>
